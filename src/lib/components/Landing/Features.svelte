			...
			<div class="grid w-full grid-cols-1 gap-8 md:grid-cols-2">
				<div class="space-y-3">
					...
					<p class="text-gray-300">
						...
						That is why we provide a platform where individuals can connect with others who
						prioritize these aspects of life. <span class="font-extrabold italic"
							>We are dedicated to finding you a partner who not only shares your physical and
							emotional needs, but also complements your soul.</span
						>
					</p>
				</div>
				...
				<div class="space-y-3">
					...
					<p class="text-gray-300">
						...
						hearts unite with a purposeful intention to nurture their spiritual connection, they can
						build a strong foundation for their relationship. This provides a sense of meaning,
						purpose, and fulfillment. Finding a partner with whom you can share your spiritual
						journey can be a beautiful and transformative experience, and it is a vital aspect to
						consider when seeking a lifelong partner. <span class="font-extrabold italic"
							>At ShubhSambandh, we believe in the power of spiritual compatibility to foster a love
				...
				<div class="space-y-3">
					...
					<p class="text-gray-300">
						...
						profiles, scams, and other potential hazards. We believe that a safe and secure
						environment is essential for fostering genuine connections between our users, and we're
						committed to maintaining that environment at all times. <span
							class="font-extrabold italic"
							>With our website, you can trust that your search for love will be protected and
							secure, allowing you to focus on finding your soulmate.</span
						>
					</p>
				</div>
				...
				<div class="space-y-3">
					...
					<p class="text-gray-300">
						...
						Our platform is designed to connect people who are serious about finding a lifelong
						partner and creating a fulfilling, purposeful relationship. Our community is made up of
						people who believe in the power of love, who are committed to personal growth, and who
						are willing to support each other in their journey towards finding true happiness. <span
							class="font-extrabold italic"
							>We believe that by creating a supportive and empowering environment, we can help our
							users find the love and companionship they've been searching for.</span
						>
					</p>
				</div>
				...
				<div class="space-y-3">
					...
					<p class="text-gray-300">
						...
						perfect match by highlighting their unique qualities and what they're looking for in a
						partner. We verify every profile to ensure that our users are interacting with real
						people who are genuinely interested in finding love. With ShubhSambandh, you can trust
						that you're connecting with quality profiles of people who are serious about finding a
						partner and building a purposeful relationship.
					</p>
				</div>
