...
<form on:submit={handleSubmit} class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
	...
	<div class="col-span-full">
		<label for="disease" class="block mb-2 text-sm text-white "
	...
	{#if currentMedicalCondition}
		<div class="col-span-full">
			<label for="medicalConditions" class="block mb-2 text-sm text-white "
	...
	{#if diseases.includes(currentMedicalInfo) && currentMedicalCondition}
		<div class="mt-2 col-span-full">
			<label for="additionalMedicalInfo" class="block mb-2 text-sm text-white "
	...
	<div class="col-span-full">
		<label for="takingMedicine" class="block mb-2 text-sm text-white "
